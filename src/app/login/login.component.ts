...
export class LoginComponent implements OnInit {
  ...
  async checkUserisValid() {
    if (this.loginForm.valid) {
      ...
      let httpParams = new HttpParams().append("emailId", formValue.email).append("loginPassword", formValue.loginPassword);
      ...
      this.loaderTimeout = setTimeout(() => {
        ...
        try {
          ...
          if (err.status === 0) {
            ...
            this.errorMessage = "EmailId or Password is Incorrect";
          }
        }
